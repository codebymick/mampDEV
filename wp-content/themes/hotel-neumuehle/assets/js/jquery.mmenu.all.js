...
(function (root, factory) {
                ...
                _initAnchors: function () {
                    ...
                    r.$body.on(o.click + "-oncanvas", "a[href]", function (i) {
                        ...
                        if (o && i.preventDefault(), !o && r && a.is("." + s.listview + " > li > a") && !a.is('[rel="external"]') && !a.is('[target="_blank"]')) {
                            ...
                            var f = t.__valueOrFn(t.opts.onClick.preventDefault, a, "<?php the_permalink(); ?>" == d.slice(0, 1));
            ...
            setup: function () {
                ...
                o = e[t].glbl, "boolean" == typeof r && (r = {
                    ...
                    var n = t.find("." + i.prev + ", ." + i.next).each(function () {
                        a.__sr_aria(e(this), "owns", e(this).attr("href").replace("<?php the_permalink(); ?>", ""))
                    });
            ...
            setup: function () {
                if (this.opts.offCanvas) {
                    ...
                    if (o = e[t].glbl, "boolean" == typeof a && (a = {
                        ...
                        var r = "<?php the_permalink(); ?>" + s.$menu.attr("id");
    ...
    function (e) {
        ...
        e[t].addons[n] = {
            ...
            clickAnchor: function (t, s) {
                ...
                if (s) {
                    var a = t.attr("href");
                    if (a.length > 1 && "<?php the_permalink(); ?>" == a.slice(0, 1)) try {
                        var o = e(a, this.$menu);
                        if (o.is("." + i.panel))
            ...
            setup: function () {
                ...
                if (o = e[t].glbl, "boolean" == typeof r && (r = {
                        ...
                        t.find("." + i.divider).each(function () {
                            ...
                            n.length && (t.children("." + i.next).length || (t.wrapInner("<span />"), t.prepend('<a href="<?php the_permalink(); ?>" class="' + i.next + " " + i.fullsubopen + '" />')))
                        })
                    }), r.fixed) {
    ...
    function (e) {
        ...
        e[t].addons[n][i] = function (n, i) {
            var s = e[t]._c,
                a = (e[t].glbl, e('<a class="' + s.close + " " + s.btn + '" href="<?php the_permalink(); ?>" />').appendTo(n));
            return this.bind("setPage:after", function (e) {
                a.attr("href", "<?php the_permalink(); ?>" + e.attr("id"))
    ...
    function (e) {
        ...
        e[t].addons[n][i] = function (i, s) {
            var a, o, r, l = e[t]._c,
                d = e('<a class="' + l.next + " " + l.btn + '" href="<?php the_permalink(); ?>" />').appendTo(i);
    ...
    function (e) {
        ...
        e[t].addons[n][i] = function (i, s) {
            var a = e[t]._c,
                o = e('<a class="' + a.prev + " " + a.btn + '" href="<?php the_permalink(); ?>" />').appendTo(i);
            this.bind("initNavbar:after", function (e) {
    ...
    function (e) {
        ...
        function n(e) {
            try {
                return !("<?php the_permalink(); ?>" == e || "<?php the_permalink(); ?>" != e.slice(0, 1) || !l.$page.find(e).length)
            } catch (t) {
                return !1
            }
        }
                        ...
                        if (h.each(function () {
                                ...
                                if (!t.is("." + s.panel) || !t.is("." + s.vertical)) {
                                    if (!t.children("." + s.search).length) {
                                        ...
                                        if (i && e('<a class="' + s.btn + " " + s.clear + '" href="<?php the_permalink(); ?>" />').appendTo(f).on(o.click + "-searchfield", function (e) {
                                                e.preventDefault(), u.val("").trigger(o.keyup + "-searchfield")
                                            }), a) {
                                            for (p in a) f.attr(p, a[p]);
                                            h && !i && e('<a class="' + s.btn + " " + s.next + '" href="<?php the_permalink(); ?>" />').appendTo(f).on(o.click + "-searchfield", function (e) {
        ...
        e[t].addons[n] = {
            setup: function () {
                ...
                if (o = e[t].glbl, "boolean" == typeof r && (r = {
                    ...
                    var l = function (e) {
                        e = e.split("?")[0].split("<?php the_permalink(); ?>")[0];
