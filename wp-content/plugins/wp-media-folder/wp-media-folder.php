...
if (!empty($option_mediafolder) || is_admin()) {
    ...
    require_once( WP_MEDIA_FOLDER_PLUGIN_DIR . 'class/class-display-own-media.php' );
    ...
    if (isset($useorder) && $useorder == 1) {
        ...
        require_once( WP_MEDIA_FOLDER_PLUGIN_DIR . 'class/class-fillter-size.php' );
